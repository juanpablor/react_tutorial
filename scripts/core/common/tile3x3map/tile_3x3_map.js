...
tile_3x3_map.size = '3x3';
tile_3x3_map.type = 'map';
tile_3x3_map.needData = true;

tile_3x3_map_save_initial = function() {
    return defaultSaveData();
};

tile_3x3_map.tile_3x3_map_create = function(ele) {
    var result = tile_3x3_map_save_initial();
    ...
    var newtile = { //the new tile
        ...
        size: tile_3x3_map.size.split('x'),
        type: tile_3x3_map.type
    };
...
tile_3x3_map.tile_3x3_map_save = false;

tile_3x3_map_format_data = function(data, settings, sources) {
    var returns = {};
...
tile_3x3_map.tile_3x3_map_draw = function(ele) {
    ...
    var data = tile_3x3_map_format_data(ele.parent.data, ele.settings, ele.parent.sources);
    ...
    var location = [ 36.20541189, -115.32555225 ];
    ...
    tile_3x3_map_draw_back(ele);
};

tile_3x3_map_draw_back = function(ele) { //can be used to update any stuff on back of tile, atm only does sources
    defaultsaveBack(ele);
};