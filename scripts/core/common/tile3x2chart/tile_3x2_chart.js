...
tile_3x2_chart.size = '3x2';
tile_3x2_chart.type = 'chart';
tile_3x2_chart.needData = true;

tile_3x2_chart_save_initial = function() {
    return defaultSaveData();
};

tile_3x2_chart.tile_3x2_chart_create = function(ele) {
    var result = tile_3x2_chart_save_initial();
    ...
    var newtile = { //the new tile
        ...
        size: tile_3x2_chart.size.split('x'),
        type: tile_3x2_chart.type
    };
...
tile_3x2_chart.tile_3x2_chart_save = false;

tile_3x2_chart_format_data = function(data, settings, sources) {
    var newobj = [];
...
tile_3x2_chart.tile_3x2_chart_draw = function(ele) {
    var formatter = tile_3x2_chart_format_data(ele.parent.data, mergeObjects(ele.settings, ele.parent.settings), mergeObjects(ele.sources, ele.parent.sources));
    ...
    stuff.color = {
        pattern: ['#5ab0ee', '#b5a1dd', '#2ec2c5', '#f4984e', '#d57b7e']
    };
    ...
    //redraw backside
    tile_3x2_chart_draw_back(ele);
};

tile_3x2_chart_draw_back = function(ele) {
    defaultsaveBack(ele);
}