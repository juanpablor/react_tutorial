...
tile_5x2_chart.size = '5x2';
tile_5x2_chart.type = 'chart';
tile_5x2_chart.needData = true;

tile_5x2_chart_save_initial = function() {
    return defaultSaveData();
};

tile_5x2_chart.tile_5x2_chart_create = function(ele) {
    var result = tile_5x2_chart_save_initial();
    ...
    var newtile = { //the new tile
        ...
        size: tile_5x2_chart.size.split('x'),
        type: tile_5x2_chart.type
    };
...
tile_5x2_chart.tile_5x2_chart_save = false;

tile_5x2_chart_format_data = function(data, settings, sources) {
    var newobj = [];
...
tile_5x2_chart.tile_5x2_chart_draw = function(ele) {
    var formatter = tile_5x2_chart_format_data(ele.parent.data, mergeObjects(ele.settings, ele.parent.settings), mergeObjects(ele.sources, ele.parent.sources));
    ...
    //redraw backside
    tile_5x2_chart_draw_back(ele);
};

tile_5x2_chart_draw_back = function(ele) {
    defaultsaveBack(ele);
}