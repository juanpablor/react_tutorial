...
tile_9x3_table.size = '9x3';
tile_9x3_table.type = 'table';
tile_9x3_table.needData = true;

tile_9x3_table_save_initial = function() {
    return defaultSaveData();
};

tile_9x3_table.tile_9x3_table_create = function(ele) {
    var result = tile_9x3_table_save_initial();
    ...
    var newtile = { //the new tile
        ...
        size: tile_9x3_table.size.split('x'),
        type: tile_9x3_table.type
    };
...
tile_9x3_table.tile_9x3_table_save = false;

tile_9x3_table_format_data = function(data, settings, sources) {
    var ret = [];
...
tile_9x3_table.tile_9x3_table_draw = function(ele) {
    ...
    var objects = tile_9x3_table_format_data(ele.parent.data, ele.settings, ele.parent.sources);
    if(objects.length > 0) {
    ...
    tile_9x3_table_draw_back(ele);
};

tile_9x3_table_draw_back = function(ele) { //can be used to update any stuff on back of tile, atm only does sources
    defaultsaveBack(ele);
};