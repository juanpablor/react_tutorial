...
tile_3x3_chart.size = '3x3';
tile_3x3_chart.type = 'chart';
tile_3x3_chart.needData = true;

tile_3x3_chart_save_initial = function() {
    return defaultSaveData();
};

tile_3x3_chart.tile_3x3_chart_create = function(ele) {
    var result = tile_3x3_chart_save_initial();
    ...
    var newtile = { //the new tile
        ...
        size: tile_3x3_chart.size.split('x'),
        type: tile_3x3_chart.type
    };
...
tile_3x3_chart.tile_3x3_chart_save = false;

tile_3x3_chart_format_data = function(data, settings, sources) {
    var newobj = [];
...
tile_3x3_chart.tile_3x3_chart_draw = function(ele) {
    var formatter = tile_3x3_chart_format_data(ele.parent.data, mergeObjects(ele.settings, ele.parent.settings), mergeObjects(ele.sources, ele.parent.sources));
    ...
    //redraw backside
    tile_3x3_chart_draw_back(ele);
};

tile_3x3_chart_draw_back = function(ele) {
    defaultsaveBack(ele);
}